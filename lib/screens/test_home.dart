...
import 'package:progetto_wearable/screens/impact.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';

class HomePage_temp extends StatelessWidget {
  HomePage_temp({Key? key}) : super(key: key);

  static const routename = 'HomePageTest';

  @override
  Widget build(BuildContext context) {
    print('${HomePage_temp.routename} built');

    return Scaffold(
      appBar: AppBar(
        title: Text(HomePage_temp.routename),
      ),
      body: Center(
        child: Column(
